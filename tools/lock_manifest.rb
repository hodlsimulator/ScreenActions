#!/usr/bin/env ruby
# lock_manifest.rb — Idempotent; safe w/ or w/o args; never fails build.
require "json"
...
# Package paths live under WebRes/ inside the .appex
icons = {
...
# Keep nativeMessaging + essentials
...
# Avoid default_locale unless you actually ship _locales root
