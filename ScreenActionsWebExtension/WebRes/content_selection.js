// content_selection.js — keep last selection/title/url fresh (works with three-dots too when popover is opened)
(() => {
  ...
  function push() {
    ...
    setTimeout(() => {
      scheduled = false;
      try {
        RT.sendMessage({ cmd: "selUpdate", payload: { selection: textSel(), title: pageTitle(), url: canonicalURL() } });
      } catch {}
    }, 60);
  }
