...
(() => {
  ...
  const RT =
    ...
    (typeof safari !== 'undefined' && safari.runtime) ? safari.runtime :
    undefined;
  ...
  function okResult(extra = {}) { return { ok: true,  ...extra }; }
  function errResult(message = 'Native bridge error.') { return { ok: false, message }; }
  ...
  async function runQueue() {
    ...
    try {
      ...
      // TEMP DIAGNOSTIC: log native replies so we can see action + payloads.
