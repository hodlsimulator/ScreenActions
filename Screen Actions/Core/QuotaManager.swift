...
//
//  Shared (App + Extensions). Uses App Group storage when available.
//
...
enum QuotaManager {
    ...
    private static var defaults: UserDefaults {
        // Always try App Group first (works in app and extension if entitlement exists), fallback to standard.
